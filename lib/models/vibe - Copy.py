...
class TemporalEncoder(nn.Module):
    def __init__(
        ...
        self.gru = nn.GRU(
            ...
            num_layers=n_layers,
            batch_first=True  # Set batch_first to True for compatibility with input shape (batch_size, sequence_length, 2048)
        )
...
class VIBE(nn.Module):
    def __init__(
            ...
            bidirectional=False,
            use_residual=True,
            pretrained=osp.join(VIBE_DATA_DIR, 'model_checkpoint.pt'),
    ):
